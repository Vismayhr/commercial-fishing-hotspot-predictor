...
class Data():
	...
	def query_for_past_date(self, year, week):
		...
		for polygon in self.polygon_grid.polygons:
			data = {}
			data['lat1'] = polygon['bottom_edge']
			data['lon1'] = polygon['left_edge']

			data['lat2'] = polygon['bottom_edge']
			data['lon2'] = polygon['right_edge']

			data['lat3'] = polygon['top_edge']
			data['lon3'] = polygon['right_edge']

			data['lat4'] = polygon['top_edge']
			data['lon4'] = polygon['left_edge']
